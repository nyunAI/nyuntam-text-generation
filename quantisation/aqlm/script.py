...
@dataclass
class Script:
    script_name: str = field(init=True)
    ...
    def __post_init__(self):
        assert self._script_root.exists(), f"Script root {self._script_root} does not exist."
        assert self._script_root.is_dir(), f"Script root {self._script_root} is not a directory."
        assert (self._script_root / self.script_name).exists(), f"Script {self.script_name} does not exist in {self._script_root}."
